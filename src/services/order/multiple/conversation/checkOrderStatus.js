...
async function checkOrderStatus(ctx, conversation, order, multiple, fileId) {
  ...
  if (status.msg.text == "Да, все правильно!") {
    ...
    return await sendOrderFileToServer(order, ctx, fileId);
    ...
    return await multiple(conversation, ctx);
  }
}
